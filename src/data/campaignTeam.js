...
export const FOUNDER = {
  name: "MINDY MOORE",
  title: "Founder & CEO — Aethon Apex IP Holdings LLC",
...
export const RESEARCH_SOURCES = [
  ...
  },
  {
    ...
    type: "Peer-Reviewed",
    date: "2001",
    body: "NASA-funded study documenting LED-based photobiomodulation accelerating wound healing and cellular regeneration in space medicine.",
...
export const DISCLAIMERS = [
  ...
  },
  {
    ...
    color: "#9B30FF",
    body: "All device architectures, engineering documentation, trade secret declarations, patent claim drafts, and proprietary integration methodologies are the exclusive intellectual property of Aethon Apex IP Holdings LLC. Trade secrets are protected under the Nevada Uniform Trade Secrets Act (NRS 600A) and the Defend Trade Secrets Act (DTSA) (18 U.S.C. § 1836). Unauthorized reproduction, disclosure, or use is prohibited. Document ID: ZA-INV-MASTER-001 · Rev A — Not for Public Distribution.",
  },
];
